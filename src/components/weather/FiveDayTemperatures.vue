<template>
  <div>
    ...
    <b-card v-if="Object.keys(fiveDayWeatherForecast).length" title="5 Day Forecast" :sub-title="cityStateLocation ? cityStateLocation.city + ', ' + cityStateLocation.principalSubdivision : null">
        ...
        <b-card v-if="weekdays.Monday && weekdays.Monday.weatherData.length" title="Monday" :sub-title="weekdays.Monday.date"> -->
          <weekday-weather-card :weekdayWeather="weekdays.Monday" />
        </b-card>
        <b-card v-if="weekdays.Tuesday && weekdays.Tuesday.weatherData.length" title="Tuesday" :sub-title="weekdays.Tuesday.date">
          <weekday-weather-card :weekdayWeather="weekdays.Tuesday" />
        </b-card>
        <b-card v-if="weekdays.Wednesday && weekdays.Wednesday.weatherData.length" title="Wednesday" :sub-title="weekdays.Wednesday.date">
          <weekday-weather-card :weekdayWeather="weekdays.Wednesday" />
        </b-card>
        <b-card v-if="weekdays.Thursday && weekdays.Thursday.weatherData.length" title="Thursday" :sub-title="weekdays.Thursday.date">
          <weekday-weather-card :weekdayWeather="weekdays.Thursday" />
        </b-card>
        <b-card v-if="weekdays.Friday && weekdays.Friday.weatherData.length" title="Friday" :sub-title="weekdays.Friday.date">
          <weekday-weather-card :weekdayWeather="weekdays.Friday" />
        </b-card>
        <b-card v-if="weekdays.Saturday && weekdays.Saturday.weatherData.length" title="Saturday" :sub-title="weekdays.Saturday.date">
          <weekday-weather-card :weekdayWeather="weekdays.Saturday" />
        </b-card>
        <b-card v-if="weekdays.Sunday && weekdays.Sunday.weatherData.length" title="Sunday" :sub-title="weekdays.Sunday.date">
